...
/**
 *  \file       notas/myobject_contact.php
 *  \ingroup    notas
...
dol_include_once('/notas/class/myobject.class.php');
dol_include_once('/notas/lib/notas_myobject.lib.php');

// Load translation files required by the page
$langs->loadLangs(array("notas@notas", "companies", "other", "mails"));
...
$permission = $user->rights->notas->myobject->write;
...
if ($object->id) {
	...
	$linkback = '<a href="'.dol_buildpath('/notas/myobject_list.php', 1).'?restore_lastsearch_values=1'.(!empty($socid) ? '&socid='.$socid : '').'">'.$langs->trans("BackToList").'</a>';
