...
/**
 *  \file       easynotes/myobject_contact.php
 *  \ingroup    easynotes
...
dol_include_once('/easynotes/class/myobject.class.php');
dol_include_once('/easynotes/lib/easynotes_myobject.lib.php');
...
$permission = $user->rights->easynotes->myobject->write;
...
if ($object->id) {
	...
	$linkback = '<a href="'.dol_buildpath('/easynotes/myobject_list.php', 1).'?restore_lastsearch_values=1'.(!empty($socid) ? '&socid='.$socid : '').'">'.$langs->trans("BackToList").'</a>';
