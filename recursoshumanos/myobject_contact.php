...
/**
 *  \file       recursoshumanos/myobject_contact.php
...
dol_include_once('/recursoshumanos/class/myobject.class.php');
dol_include_once('/recursoshumanos/lib/recursoshumanos_myobject.lib.php');

// Load translation files required by the page
$langs->loadLangs(array("recursoshumanos@recursoshumanos", "companies", "other", "mails"));
...
$permission = $user->rights->recursoshumanos->myobject->write;
...
if ($object->id) {
	...
	$linkback = '<a href="'.dol_buildpath('/recursoshumanos/myobject_list.php', 1).'?restore_lastsearch_values=1'.(!empty($socid) ? '&socid='.$socid : '').'">'.$langs->trans("BackToList").'</a>';
